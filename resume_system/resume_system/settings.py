...
SECRET_KEY = 'django-insecure-6f_c!%p#lji551&fogm6qg%&cv^2^f&x)v2e6_&_xgrtm2n3($'
...
INSTALLED_APPS = [
    ...
    'rest_framework.authtoken',    # Add this for token-based auth
    'ranking',  
    'main', 
]
...
# For Token-based authentication configuration
REST_FRAMEWORK = {
